...
namespace Hotel_Layer.DataAccess.Migrations
{
    ...
    [Migration("20240105200334_mig_country_gender")]
    partial class mig_country_gender
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.City", b =>
                {
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.WorkPlace", b =>
                {
                    b.Property<int>("WorkPlaceID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.AppUser", b =>
                {
                    b.HasOne("Hotel_Layer.Entities.Concrete.WorkPlace", "WorkPlace")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("Hotel_Layer.Entities.Concrete.Contact", b =>
                {
                    b.HasOne("Hotel_Layer.Entities.Concrete.MessageCategory", null)
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Hotel_Layer.Entities.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Hotel_Layer.Entities.Concrete.AppUser", null)
                        .WithMany()
